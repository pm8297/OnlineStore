...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main bg-graycolor">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header text-secondary">Quản lý bình luận</h1>
        </div>
    </div>
            ...
            <table class="table table-hover ">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Mail Comment</th>
                        <th scope="col">Date Comment</th>
                        <th scope="col">Details Comment</th>
                ...
                <tbody>
                <?php
                    $sql = "SELECT * FROM comment INNER JOIN product ON comment.prd_id = product.prd_id  ORDER BY comm_id ASC LIMIT $per_row,$rows_per_page";
                    ...
                    while ($row = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            ...
                            <td class="form-group">
                                <a href="index.php?page_layout=edit_comment&comm_id=<?php echo $row['comm_id']; ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                <a href="del_comment.php?comm_id=<?php echo $row['comm_id']; ?>" class="btn btn-danger"><i class="fas fa-times "></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
